...
extern double aplicar_ga(int name, int p, const double *, int, int, int, double, int, int, int *, int);
...
//	Call Metaheuristic
	double value = aplicar_ga(name, p, d, n, n_gen, tam_pob, m_rate, ngm, nem, sol, nh);
